...
const retiredSourcePatterns = [
  ...
  { name: '旧全局导航/开关 class', regex: /\b(?:nav-item|theme-toggle-btn|toggle-switch(?:-thumb|-lg|-sm)?|storage-input)\b/g },
  { name: '旧全局弹层/管理 class', regex: /\b(?:modal-overlay|modal-panel|btn-close-ghost|admin-tab|tab-content-enter)\b/g },
  { name: '旧播放器全局 class', regex: /\b(?:player-controls|progress-bar(?:-fill|-thumb)?|gesture-overlay)\b/g },
