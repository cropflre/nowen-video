...
func AutoMigrateTranscodeExecution(db *gorm.DB) error {
	...
	// Existing artifact rows were created before Media/Fingerprint/Planner were
	// stored on the artifact itself. Backfill from the owning Job without
	// deleting or rewriting historical task/output data. The correlated update
